...
export const HOTKEY_ACTIONS: HotkeyActionDef[] = [
  ...
  // the ctrl/meta variants navigate while keeping the zoom (see ZoomableImage)
  { id: "images.next-image", label: "Next image", context: "images", defaultKeys: ["ArrowRight", "l", "ctrl+ArrowRight", "meta+ArrowRight"] },
  { id: "images.previous-image", label: "Previous image", context: "images", defaultKeys: ["ArrowLeft", "h", "ctrl+ArrowLeft", "meta+ArrowLeft"] },
