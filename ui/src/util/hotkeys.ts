...
export const HOTKEY_ACTIONS: HotkeyActionDef[] = [
  ...
  { id: "tagging.select-next", label: "Highlight next tag", context: "tagging-dialog", defaultKeys: ["ArrowDown", "j"], allowInInputs: true },
  { id: "tagging.select-previous", label: "Highlight previous tag", context: "tagging-dialog", defaultKeys: ["ArrowUp", "k"], allowInInputs: true },
