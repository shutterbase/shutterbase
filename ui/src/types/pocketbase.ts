...
export enum Collections {
	Cameras = "cameras",
	HotkeyEvents = "hotkey_events",
	HotkeyMappings = "hotkey_mappings",
...
export type HotkeyEventsRecord = {
	defaultHotkey?: string
	description: string
	event: string
}

export type HotkeyMappingsRecord = {
...
export type HotkeyEventsResponse<Texpand = unknown> = Required<HotkeyEventsRecord> & BaseSystemFields<Texpand>
export type HotkeyMappingsResponse<Texpand = unknown> = Required<HotkeyMappingsRecord> & BaseSystemFields<Texpand>
...
export type CollectionRecords = {
	...
	hotkey_events: HotkeyEventsRecord
	hotkey_mappings: HotkeyMappingsRecord
...
export type CollectionResponses = {
	...
	hotkey_events: HotkeyEventsResponse
	hotkey_mappings: HotkeyMappingsResponse
...
export type TypedPocketBase = PocketBase & {
	...
	collection(idOrName: 'hotkey_events'): RecordService<HotkeyEventsResponse>
	collection(idOrName: 'hotkey_mappings'): RecordService<HotkeyMappingsResponse>
