<template>
  <div>
    ...
    <button
      ...
      class="p-2 mr-1 text-primary-500 rounded-lg hover:text-primary-900 hover:bg-primary-100 dark:text-primary-400 dark:hover:text-white dark:hover:bg-primary-800 focus:ring-2 focus:ring-accent-500 dark:focus:ring-accent-500"
    >
    ...
    <!-- Dropdown menu -->
    <div
      class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none border border-primary-200 bg-surface rounded divide-y divide-primary-200 shadow-panel dark:border-primary-800 dark:divide-primary-800 dark:bg-surface-dark dark:shadow-panel-dark rounded-xl"
      id="notification-dropdown"
    >
      <div class="block py-2 px-4 text-base font-medium text-center text-primary-700 bg-surface-muted dark:bg-surface-dark-muted dark:text-primary-300">Notifications</div>
      <div>
        <a href="#" class="flex py-3 px-4 border-b border-primary-200 hover:bg-primary-100 dark:border-primary-800 dark:hover:bg-primary-800">
          <div class="flex-shrink-0">
            ...
            <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-surface bg-primary-700 dark:border-surface-dark">
          ...
          <div class="pl-3 w-full">
            <div class="text-primary-500 font-normal text-sm mb-1.5 dark:text-primary-400">
              New message from
        ...
        <a href="#" class="flex py-3 px-4 border-b border-primary-200 hover:bg-primary-100 dark:border-primary-800 dark:hover:bg-primary-800">
          <div class="flex-shrink-0">
            ...
            <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-primary-900 rounded-full border border-surface dark:border-surface-dark">
              <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="pl-3 w-full">
            <div class="text-primary-500 font-normal text-sm mb-1.5 dark:text-primary-400">
              <span class="font-semibold text-primary-900 dark:text-white">Jese leos</span>
              and
        ...
        <a href="#" class="flex py-3 px-4 border-b border-primary-200 hover:bg-primary-100 dark:border-primary-800 dark:hover:bg-primary-800">
          <div class="flex-shrink-0">
            ...
            <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-error-600 rounded-full border border-surface dark:border-surface-dark">
              <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill-rule="evenodd"
          ...
          <div class="pl-3 w-full">
            <div class="text-primary-500 font-normal text-sm mb-1.5 dark:text-primary-400">
              <span class="font-semibold text-primary-900 dark:text-white">Joseph Mcfall</span>
              and
        ...
        <a href="#" class="flex py-3 px-4 border-b border-primary-200 hover:bg-primary-100 dark:border-primary-800 dark:hover:bg-primary-800">
          <div class="flex-shrink-0">
            ...
            <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-success-500 rounded-full border border-surface dark:border-surface-dark">
              <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill-rule="evenodd"
          ...
          <div class="pl-3 w-full">
            <div class="text-primary-500 font-normal text-sm mb-1.5 dark:text-primary-400">
              <span class="font-semibold text-primary-900 dark:text-white">Leslie Livingston</span>
        ...
        <a href="#" class="flex py-3 px-4 hover:bg-primary-100 dark:hover:bg-primary-800">
          <div class="flex-shrink-0">
            ...
            <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-accent-500 rounded-full border border-surface dark:border-surface-dark">
              <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path
