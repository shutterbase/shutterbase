  ...
  <div ref="dropzoneContainer" id="dropzoneContainer" class="flex items-center justify-center w-full">
    ...
    >
      <div class="flex flex-col items-center justify-center pt-5 pb-6">
        ...
        <p class="mb-2 text-sm text-primary-600 dark:text-primary-300">
          <span class="font-semibold text-primary-800 dark:text-primary-100">Click to upload</span> or drag and drop
        </p>
