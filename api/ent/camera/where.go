...
func Description(v string) predicate.Camera {
	return predicate.Camera(sql.FieldEQ(FieldDescription, v))
}
...
func DescriptionEQ(v string) predicate.Camera {
	return predicate.Camera(sql.FieldEQ(FieldDescription, v))
}

// DescriptionNEQ applies the NEQ predicate on the "description" field.
func DescriptionNEQ(v string) predicate.Camera {
	return predicate.Camera(sql.FieldNEQ(FieldDescription, v))
}

// DescriptionIn applies the In predicate on the "description" field.
func DescriptionIn(vs ...string) predicate.Camera {
	return predicate.Camera(sql.FieldIn(FieldDescription, vs...))
}

// DescriptionNotIn applies the NotIn predicate on the "description" field.
func DescriptionNotIn(vs ...string) predicate.Camera {
	return predicate.Camera(sql.FieldNotIn(FieldDescription, vs...))
}

// DescriptionGT applies the GT predicate on the "description" field.
func DescriptionGT(v string) predicate.Camera {
	return predicate.Camera(sql.FieldGT(FieldDescription, v))
}

// DescriptionGTE applies the GTE predicate on the "description" field.
func DescriptionGTE(v string) predicate.Camera {
	return predicate.Camera(sql.FieldGTE(FieldDescription, v))
}

// DescriptionLT applies the LT predicate on the "description" field.
func DescriptionLT(v string) predicate.Camera {
	return predicate.Camera(sql.FieldLT(FieldDescription, v))
}

// DescriptionLTE applies the LTE predicate on the "description" field.
func DescriptionLTE(v string) predicate.Camera {
	return predicate.Camera(sql.FieldLTE(FieldDescription, v))
}

// DescriptionContains applies the Contains predicate on the "description" field.
func DescriptionContains(v string) predicate.Camera {
	return predicate.Camera(sql.FieldContains(FieldDescription, v))
}

// DescriptionHasPrefix applies the HasPrefix predicate on the "description" field.
func DescriptionHasPrefix(v string) predicate.Camera {
	return predicate.Camera(sql.FieldHasPrefix(FieldDescription, v))
}

// DescriptionHasSuffix applies the HasSuffix predicate on the "description" field.
func DescriptionHasSuffix(v string) predicate.Camera {
	return predicate.Camera(sql.FieldHasSuffix(FieldDescription, v))
}

// DescriptionEqualFold applies the EqualFold predicate on the "description" field.
func DescriptionEqualFold(v string) predicate.Camera {
	return predicate.Camera(sql.FieldEqualFold(FieldDescription, v))
}

// DescriptionContainsFold applies the ContainsFold predicate on the "description" field.
func DescriptionContainsFold(v string) predicate.Camera {
	return predicate.Camera(sql.FieldContainsFold(FieldDescription, v))
}
...
func HasOwner() predicate.Camera {
	return predicate.Camera(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasOwnerWith(preds ...predicate.User) predicate.Camera {
	return predicate.Camera(func(s *sql.Selector) {
		step := newOwnerStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasCreatedBy() predicate.Camera {
	return predicate.Camera(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCreatedByWith(preds ...predicate.User) predicate.Camera {
	return predicate.Camera(func(s *sql.Selector) {
...
func HasModifiedBy() predicate.Camera {
	return predicate.Camera(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasModifiedByWith(preds ...predicate.User) predicate.Camera {
	return predicate.Camera(func(s *sql.Selector) {
