...
func (_q *RoleQuery) QueryProjectAssignments() *ProjectAssignmentQuery {
...
func (_q *RoleQuery) WithProjectAssignments(opts ...func(*ProjectAssignmentQuery)) *RoleQuery {
	query := (&ProjectAssignmentClient{config: _q.config}).Query()
...
func (_q *RoleQuery) loadProjectAssignments(ctx context.Context, query *ProjectAssignmentQuery, nodes []*Role, init func(*Role), assign func(*Role, *ProjectAssignment)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(projectassignment.FieldRoleID)
	}
