...
func (*Role) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case role.FieldKey, role.FieldDescription:
...
func (r *Role) QueryProjectAssignments() *ProjectAssignmentQuery {
	return NewRoleClient(r.config).QueryProjectAssignments(r)
}
