...
func (_q *ProjectQuery) QueryUploads() *UploadQuery {
...
func (_q *ProjectQuery) QueryImages() *ImageQuery {
...
// QueryImageTags chains the current query on the "imageTags" edge.
func (_q *ProjectQuery) QueryImageTags() *ImageTagQuery {
...
func (_q *ProjectQuery) QueryProjectAssignments() *ProjectAssignmentQuery {
...
func (_q *ProjectQuery) QueryDownloadConfigs() *DownloadConfigQuery {
...
// QueryActiveForUsers chains the current query on the "activeForUsers" edge.
func (_q *ProjectQuery) QueryActiveForUsers() *UserQuery {
...
func (_q *ProjectQuery) WithUploads(opts ...func(*UploadQuery)) *ProjectQuery {
	query := (&UploadClient{config: _q.config}).Query()
...
func (_q *ProjectQuery) WithImages(opts ...func(*ImageQuery)) *ProjectQuery {
	query := (&ImageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithImageTags tells the query-builder to eager-load the nodes that are connected to
// the "imageTags" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *ProjectQuery) WithImageTags(opts ...func(*ImageTagQuery)) *ProjectQuery {
	query := (&ImageTagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProjectQuery) WithProjectAssignments(opts ...func(*ProjectAssignmentQuery)) *ProjectQuery {
	query := (&ProjectAssignmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProjectQuery) WithDownloadConfigs(opts ...func(*DownloadConfigQuery)) *ProjectQuery {
	query := (&DownloadConfigClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithActiveForUsers tells the query-builder to eager-load the nodes that are connected to
// the "activeForUsers" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *ProjectQuery) WithActiveForUsers(opts ...func(*UserQuery)) *ProjectQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withActiveForUsers = query
	return _q
}
...
func (_q *ProjectQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Project, error) {
	...
	if query := _q.withUploads; query != nil {
		if err := _q.loadUploads(ctx, query, nodes,
			func(n *Project) { n.Edges.Uploads = []*Upload{} },
			func(n *Project, e *Upload) { n.Edges.Uploads = append(n.Edges.Uploads, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withImageTags; query != nil {
	...
	if query := _q.withProjectAssignments; query != nil {
		if err := _q.loadProjectAssignments(ctx, query, nodes,
			func(n *Project) { n.Edges.ProjectAssignments = []*ProjectAssignment{} },
			func(n *Project, e *ProjectAssignment) {
	...
	if query := _q.withActiveForUsers; query != nil {
...
func (_q *ProjectQuery) loadUploads(ctx context.Context, query *UploadQuery, nodes []*Project, init func(*Project), assign func(*Project, *Upload)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(upload.FieldProjectID)
	}
	query.Where(predicate.Upload(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(project.UploadsColumn), fks...))
	}))
...
func (_q *ProjectQuery) loadImages(ctx context.Context, query *ImageQuery, nodes []*Project, init func(*Project), assign func(*Project, *Image)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Project)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(image.FieldProjectID)
	}
...
func (_q *ProjectQuery) loadImageTags(ctx context.Context, query *ImageTagQuery, nodes []*Project, init func(*Project), assign func(*Project, *ImageTag)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Project)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *ProjectQuery) loadProjectAssignments(ctx context.Context, query *ProjectAssignmentQuery, nodes []*Project, init func(*Project), assign func(*Project, *ProjectAssignment)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Project)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(projectassignment.FieldProjectID)
	}
	query.Where(predicate.ProjectAssignment(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(project.ProjectAssignmentsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ProjectQuery) loadDownloadConfigs(ctx context.Context, query *DownloadConfigQuery, nodes []*Project, init func(*Project), assign func(*Project, *DownloadConfig)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Project)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(downloadconfig.FieldProjectID)
	}
	query.Where(predicate.DownloadConfig(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(project.DownloadConfigsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ProjectQuery) loadActiveForUsers(ctx context.Context, query *UserQuery, nodes []*Project, init func(*Project), assign func(*Project, *User)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Project)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(user.FieldActiveProjectID)
	}
	query.Where(predicate.User(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(project.ActiveForUsersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.ActiveProjectID
		if fk == nil {
			return fmt.Errorf(`foreign-key "active_project_id" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "active_project_id" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
